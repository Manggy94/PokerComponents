...
class TestLocalHandHistoryConverter(unittest.TestCase):
    ...
    def test_get_buy_in(self):
        ...
        buy_in = self.converter.table.total_buy_in
        self.assertIsInstance(buy_in, float)
        self.assertEqual(buy_in, 5.0)

    def test_get_level(self):
        self.converter.get_level()
        self.assertEqual(self.converter.table.level.value, 1)
        self.assertEqual(self.converter.table.level.bb, 200)
        self.assertEqual(self.converter.table.level.sb, 100)
        self.assertEqual(self.converter.table.level.ante, 25)
    ...
    def test_get_pregame(self):
        self.converter.get_pregame_info()
        ...
        self.assertEqual(self.converter.table.level, Level(value=1, bb=200, ante=25))
        self.assertEqual(self.converter.table.total_buy_in, 5.0)
    ...
    def test_convert_history(self):
        ...
        self.assertEqual(hero_stats.preflop.ratio_to_call_facing_1bet, 0)
        ...
        self.assertAlmostEqual(villain_stats.preflop.ratio_to_call_facing_1bet, 0.06, 2)
        ...
        self.assertEqual(hero_stats.flop.ratio_to_call_facing_1bet, 0)
        self.assertEqual(villain_stats.flop.ratio_to_call_facing_1bet, 0)
        ...
        # moves
        self.assertIsNone(hero_stats.flop.move_facing_1bet)
        self.assertIsNone(villain_stats.flop.move_facing_1bet)
        ...
        self.assertEqual(hero_stats.turn.ratio_to_call_facing_1bet, 0)
        self.assertEqual(villain_stats.turn.ratio_to_call_facing_1bet, 0)
        ...
        # moves
        self.assertIsNone(hero_stats.turn.move_facing_1bet)
        self.assertIsNone(villain_stats.turn.move_facing_1bet)
        ...
        self.assertEqual(hero_stats.river.ratio_to_call_facing_1bet, 0)
        self.assertEqual(villain_stats.river.ratio_to_call_facing_1bet, 0)
        ...
        # moves
        self.assertIsNone(hero_stats.river.move_facing_1bet)
        self.assertIsNone(villain_stats.river.move_facing_1bet)
...
class TestLocalHandHistoryConverter2(unittest.TestCase):
    ...
    def test_get_level(self):
        self.converter.get_level()
        level = self.converter.table.level
    ...
    def test_get_pregame(self):
        ...
        self.assertEqual(self.converter.table.level, Level(value=0, bb=30, ante=0))
        self.assertEqual(self.converter.table.total_buy_in, 5.0)
...
class TestLocalHandHistoryConverter3(unittest.TestCase):
    ...
    def test_get_pregame(self):
        ...
        self.assertEqual(self.converter.table.total_buy_in, 5)
...
class TestLocalHandHistoryConverter13(unittest.TestCase):
    def setUp(self):
        self.history_path = os.path.join(FILES_DIR, 'example13.json')
        self.converter = LocalHandHistoryConverter(data_dir=DATA_DIR)
        self.converter.get_parsed_data(self.history_path)
...
class TestLocalHandHistoryConverter14(unittest.TestCase):
    def setUp(self):
        self.history_path = os.path.join(FILES_DIR, 'example14.json')
        self.converter = LocalHandHistoryConverter(data_dir=DATA_DIR)
        self.converter.get_parsed_data(self.history_path)
...
class TestLocalHandHistoryConverter20(unittest.TestCase):
    def setUp(self):
        self.history_path = os.path.join(FILES_DIR, 'example20.json')
        self.converter = LocalHandHistoryConverter(data_dir=DATA_DIR)
        self.converter.get_parsed_data(self.history_path)
...
class TestLocalHandHistoryConverter21(unittest.TestCase):
    def setUp(self):
        self.history_path = os.path.join(FILES_DIR, 'example21.json')
        self.converter = LocalHandHistoryConverter(data_dir=DATA_DIR)
        self.converter.get_parsed_data(self.history_path)
...
class TestLocalHandHistoryConverter22(unittest.TestCase):
    def setUp(self):
        self.history_path = os.path.join(FILES_DIR, 'example22.json')
        self.converter = LocalHandHistoryConverter(data_dir=DATA_DIR)
        self.converter.get_parsed_data(self.history_path)
