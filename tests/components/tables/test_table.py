...
class TableTest(unittest.TestCase):
    ...
    def test_playing_order(self):
        ...
        self.assertIsInstance(table.players_able_to_play, list)
        self.assertEqual(table.players_able_to_play, [self.p2, self.p4, self.p3, self.p1])
        table.street = Street.FLOP
        self.assertEqual(table.playing_order, [6, 1, 2, 4])
        self.assertEqual(table.players_able_to_play, [self.p3, self.p1, self.p2, self.p4])
        ...
        self.assertEqual(table.players_able_to_play, [self.p3, self.p1, self.p4])
        ...
        action.execute()
        self.assertEqual(table.players_able_to_play, [self.p3, self.p4])
