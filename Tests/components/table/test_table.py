...
class MyTableTestCase(unittest.TestCase):
    ...
    def test_game(self):
        ...
        self.assertEqual(tab.pot, 0)
        tab.post_pregame()
        for seat in tab.playing_order:
            pl = tab.players[seat]
            print("\n", pl.name, pl.seat, pl.position, pl.init_stack, pl.stack)
        ...
        tab.flop("Qs", "Js", "Tc")
        self.assertEqual(tab.current_pot.highest_bet, 0)
