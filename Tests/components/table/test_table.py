...
class MyTableTestCase(unittest.TestCase):
    ...
    def test_game(self):
        ...
        self.assertEqual(tab.seats_playing, [4])
        self.assertEqual(tab.nb_waiting, 1)
        self.assertEqual(tab.current_player.to_call, 1050)
        ...
        self.assertEqual(tab.pot.value, 9917)
        tab.current_player.call()
        self.assertEqual(tab.current_player.to_call, 0)
        self.assertEqual(tab.pot.value, 10967)
        tab.turn("Ts")
        ...
        self.assertEqual(tab.players[4].invested, 4100)
        self.assertEqual(tab.players[4].max_reward, 10967)
        self.assertEqual(tab.players[5].invested, 267)
        self.assertEqual(tab.players[5].max_reward, 1385)
        self.assertEqual(tab.players[6].invested, 4100)
        self.assertEqual(tab.players[6].max_reward, 10967)
        tab.current_player.bet(tab.pot.value)
        self.assertEqual(tab.pot.value, 21934)
        ...
        self.assertEqual(tab.players[4].stack, 95327)
        self.assertEqual(tab.players[5].stack, 1385)
        self.assertEqual(tab.players[6].stack, 46000)
